...
path<-"/home1/kavoss/simulation_from_scratch/sim_10/"
filenames <- list.files(path=path, pattern=".fasta", full.names=TRUE,recursive = TRUE)

## naive seq
#p1 <- read.table(file="/home1/kavoss/simulation_from_scratch/sim_10/0_01/naive.fasta")
fastaFile = readDNAStringSet("/home1/kavoss/simulation_from_scratch/sim_10/0_01/naive.fasta")
seq_name = names(fastaFile)
sequence = paste(fastaFile)
p1 <- data.frame(seq_name, sequence)
